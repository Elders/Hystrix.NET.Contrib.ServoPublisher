...
SET SUMMARY="Elders.Hystrix.NET.Contrib.ServoPublisher"
SET DESCRIPTION="Elders.Hystrix.NET.Contrib.ServoPublisher"

%FAKE% %NYX% appName=Elders.Hystrix.NET.Contrib.ServoPublisher appReleaseNotes=%RELEASE_NOTES% appSummary=%SUMMARY% appDescription=%DESCRIPTION% nugetkey=%RELEASE_NUGETKEY% nugetPackageName=Hystrix.NET.Contrib.ServoPublisher
